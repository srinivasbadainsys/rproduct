...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './job-board.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_JOBBOARD_LIST actions', async () => {
    ...
    it('dispatches FETCH_JOBBOARD actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_JOBBOARD actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_JOBBOARD actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_JOBBOARD actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_JOBBOARD actions', async () => {
      const expectedActions = [
        {
