...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './job-board-shared-to.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_JOBBOARDSHAREDTO_LIST actions', async () => {
    ...
    it('dispatches FETCH_JOBBOARDSHAREDTO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_JOBBOARDSHAREDTO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_JOBBOARDSHAREDTO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_JOBBOARDSHAREDTO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_JOBBOARDSHAREDTO actions', async () => {
      const expectedActions = [
        {
