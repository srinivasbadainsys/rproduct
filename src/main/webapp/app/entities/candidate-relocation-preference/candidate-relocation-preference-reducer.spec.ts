...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './candidate-relocation-preference.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_CANDIDATERELOCATIONPREFERENCE_LIST actions', async () => {
    ...
    it('dispatches FETCH_CANDIDATERELOCATIONPREFERENCE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_CANDIDATERELOCATIONPREFERENCE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_CANDIDATERELOCATIONPREFERENCE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_CANDIDATERELOCATIONPREFERENCE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_CANDIDATERELOCATIONPREFERENCE actions', async () => {
      const expectedActions = [
        {
