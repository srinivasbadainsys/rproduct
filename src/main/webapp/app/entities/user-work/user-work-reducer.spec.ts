...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './user-work.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_USERWORK_LIST actions', async () => {
    ...
    it('dispatches FETCH_USERWORK actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_USERWORK actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_USERWORK actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_USERWORK actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_USERWORK actions', async () => {
      const expectedActions = [
        {
