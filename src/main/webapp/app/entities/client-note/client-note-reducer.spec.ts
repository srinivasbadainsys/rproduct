...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_CLIENTNOTE_LIST actions', async () => {
    ...
    it('dispatches FETCH_CLIENTNOTE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_CLIENTNOTE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_CLIENTNOTE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_CLIENTNOTE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_CLIENTNOTE actions', async () => {
      const expectedActions = [
        {
