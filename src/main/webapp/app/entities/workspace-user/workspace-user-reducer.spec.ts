...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_WORKSPACEUSER_LIST actions', async () => {
    ...
    it('dispatches FETCH_WORKSPACEUSER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_WORKSPACEUSER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_WORKSPACEUSER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_WORKSPACEUSER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_WORKSPACEUSER actions', async () => {
      const expectedActions = [
        {
