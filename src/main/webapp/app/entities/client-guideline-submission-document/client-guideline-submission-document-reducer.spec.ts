...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './client-guideline-submission-document.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_CLIENTGUIDELINESUBMISSIONDOCUMENT_LIST actions', async () => {
    ...
    it('dispatches FETCH_CLIENTGUIDELINESUBMISSIONDOCUMENT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_CLIENTGUIDELINESUBMISSIONDOCUMENT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_CLIENTGUIDELINESUBMISSIONDOCUMENT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_CLIENTGUIDELINESUBMISSIONDOCUMENT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_CLIENTGUIDELINESUBMISSIONDOCUMENT actions', async () => {
      const expectedActions = [
        {
