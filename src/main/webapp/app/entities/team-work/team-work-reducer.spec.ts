...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './team-work.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_TEAMWORK_LIST actions', async () => {
    ...
    it('dispatches FETCH_TEAMWORK actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_TEAMWORK actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_TEAMWORK actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_TEAMWORK actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_TEAMWORK actions', async () => {
      const expectedActions = [
        {
