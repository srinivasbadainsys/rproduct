...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './candidate-pipeline.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_CANDIDATEPIPELINE_LIST actions', async () => {
    ...
    it('dispatches FETCH_CANDIDATEPIPELINE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_CANDIDATEPIPELINE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_CANDIDATEPIPELINE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_CANDIDATEPIPELINE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_CANDIDATEPIPELINE actions', async () => {
      const expectedActions = [
        {
