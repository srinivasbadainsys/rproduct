    ...
    <Row>
      <Col md="8">
        <h2 data-cy="catalogueDetailsHeading">
          <Translate contentKey="rproductApp.catalogue.detail.title">Catalogue</Translate>
        </h2>
        <dl className="jh-entity-details">
          ...
          <dt>
            <span id="type">
              <Translate contentKey="rproductApp.catalogue.type">Type</Translate>
            </span>
          </dt>
          <dd>{catalogueEntity.type}</dd>
          <dt>
            <span id="typeCode">
              <Translate contentKey="rproductApp.catalogue.typeCode">Type Code</Translate>
            </span>
          </dt>
          <dd>{catalogueEntity.typeCode}</dd>
        </dl>
