...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './job-work.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_JOBWORK_LIST actions', async () => {
    ...
    it('dispatches FETCH_JOBWORK actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_JOBWORK actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_JOBWORK actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_JOBWORK actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_JOBWORK actions', async () => {
      const expectedActions = [
        {
