...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_CLIENTDOCUMENT_LIST actions', async () => {
    ...
    it('dispatches FETCH_CLIENTDOCUMENT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_CLIENTDOCUMENT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_CLIENTDOCUMENT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_CLIENTDOCUMENT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_CLIENTDOCUMENT actions', async () => {
      const expectedActions = [
        {
