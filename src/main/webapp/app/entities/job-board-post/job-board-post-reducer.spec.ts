...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_JOBBOARDPOST_LIST actions', async () => {
    ...
    it('dispatches FETCH_JOBBOARDPOST actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_JOBBOARDPOST actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_JOBBOARDPOST actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_JOBBOARDPOST actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_JOBBOARDPOST actions', async () => {
      const expectedActions = [
        {
