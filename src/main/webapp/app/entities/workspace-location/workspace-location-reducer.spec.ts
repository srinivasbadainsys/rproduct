...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './workspace-location.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_WORKSPACELOCATION_LIST actions', async () => {
    ...
    it('dispatches FETCH_WORKSPACELOCATION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_WORKSPACELOCATION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_WORKSPACELOCATION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_WORKSPACELOCATION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_WORKSPACELOCATION actions', async () => {
      const expectedActions = [
        {
