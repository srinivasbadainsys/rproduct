...
import { getEntity } from './r-user.reducer';
  ...
  return (
    <Row>
      <Col md="8">
        ...
        <Button tag={Link} to="/r-user" replace color="info" data-cy="entityDetailsBackButton">
        ...
        &nbsp;
        <Button tag={Link} to={`/r-user/${rUserEntity.id}/edit`} replace color="primary">
