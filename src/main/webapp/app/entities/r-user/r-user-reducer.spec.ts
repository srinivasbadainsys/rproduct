...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './r-user.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_RUSER_LIST actions', async () => {
    ...
    it('dispatches FETCH_RUSER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_RUSER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_RUSER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_RUSER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_RUSER actions', async () => {
      const expectedActions = [
        {
