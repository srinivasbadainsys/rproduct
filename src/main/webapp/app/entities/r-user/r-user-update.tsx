...
import { getEntity, updateEntity, createEntity, reset } from './r-user.reducer';
        ...
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <Button tag={Link} id="cancel-save" data-cy="entityCreateCancelButton" to="/r-user" replace color="info">
