        ...
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                label={translate('rproductApp.catalogueValue.catalogueId')}
                id="catalogue-value-catalogueId"
                name="catalogueId"
                data-cy="catalogueId"
                type="text"
              />
              <ValidatedField
                label={translate('rproductApp.catalogueValue.value')}
                id="catalogue-value-value"
                name="value"
                data-cy="value"
                type="text"
              />
