...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_CATALOGUEVALUE_LIST actions', async () => {
    ...
    it('dispatches FETCH_CATALOGUEVALUE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_CATALOGUEVALUE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_CATALOGUEVALUE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_CATALOGUEVALUE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_CATALOGUEVALUE actions', async () => {
      const expectedActions = [
        {
