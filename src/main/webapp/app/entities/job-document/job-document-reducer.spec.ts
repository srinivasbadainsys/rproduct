...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_JOBDOCUMENT_LIST actions', async () => {
    ...
    it('dispatches FETCH_JOBDOCUMENT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_JOBDOCUMENT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_JOBDOCUMENT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_JOBDOCUMENT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_JOBDOCUMENT actions', async () => {
      const expectedActions = [
        {
