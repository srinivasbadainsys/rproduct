...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './job-custom-attribute.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_JOBCUSTOMATTRIBUTE_LIST actions', async () => {
    ...
    it('dispatches FETCH_JOBCUSTOMATTRIBUTE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_JOBCUSTOMATTRIBUTE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_JOBCUSTOMATTRIBUTE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_JOBCUSTOMATTRIBUTE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_JOBCUSTOMATTRIBUTE actions', async () => {
      const expectedActions = [
        {
