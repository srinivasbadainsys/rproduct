...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_JOBLOCATION_LIST actions', async () => {
    ...
    it('dispatches FETCH_JOBLOCATION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_JOBLOCATION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_JOBLOCATION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_JOBLOCATION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_JOBLOCATION actions', async () => {
      const expectedActions = [
        {
