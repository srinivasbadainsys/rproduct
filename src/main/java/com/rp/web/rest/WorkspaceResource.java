...
import com.rp.service.WorkspaceService;
...
/**
 * REST controller for managing {@link com.rp.domain.Workspace}.
 */
@RestController
@RequestMapping("/api")
public class WorkspaceResource {
    ...
    public ResponseEntity<Workspace> updateWorkspace(
        ...
        Workspace result = workspaceService.update(workspace);
        return ResponseEntity
            .ok()
    ...
    public ResponseEntity<List<Workspace>> getAllWorkspaces(@org.springdoc.api.annotations.ParameterObject Pageable pageable) {
