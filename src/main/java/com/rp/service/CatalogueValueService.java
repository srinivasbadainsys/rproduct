    ...
    public Optional<CatalogueValue> partialUpdate(CatalogueValue catalogueValue) {
        ...
        return catalogueValueRepository
            ...
            .map(existingCatalogueValue -> {
                if (catalogueValue.getCatalogueId() != null) {
                    existingCatalogueValue.setCatalogueId(catalogueValue.getCatalogueId());
                }
                if (catalogueValue.getValue() != null) {
                    existingCatalogueValue.setValue(catalogueValue.getValue());
                }
